...
public class Keys {
    ...
    public static final UniqueKey<LpAssetsRecord> KEY_LP_ASSETS_PRIMARY = Internal.createUniqueKey(LpAssets.LP_ASSETS, DSL.name("KEY_lp_assets_PRIMARY"), new TableField[] { LpAssets.LP_ASSETS.DB_ID }, true);
