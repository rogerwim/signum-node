...
public class Keys {
    ...
    public static final UniqueKey<LpRecord> KEY_LP_PRIMARY = Internal.createUniqueKey(Lp.LP, DSL.name("KEY_lp_PRIMARY"), new TableField[] { Lp.LP.DB_ID }, true);
    public static final UniqueKey<LpBalancesRecord> KEY_LP_BALANCES_PRIMARY = Internal.createUniqueKey(LpBalances.LP_BALANCES, DSL.name("KEY_lp_balances_PRIMARY"), new TableField[] { LpBalances.LP_BALANCES.DB_ID }, true);
    public static final UniqueKey<LpTokensRecord> KEY_LP_TOKENS_PRIMARY = Internal.createUniqueKey(LpTokens.LP_TOKENS, DSL.name("KEY_lp_tokens_PRIMARY"), new TableField[] { LpTokens.LP_TOKENS.DB_ID }, true);
